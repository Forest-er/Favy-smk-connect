...
namespace App\Models {
     ...
     * App\Models\taks
     *
     * @method static \Illuminate\Database\Eloquent\Builder<taks>|taks newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<taks>|taks newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<taks>|taks query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class taks extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
