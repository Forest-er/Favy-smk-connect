...
<head>
  ...
  <script src="https://cdn.tailwindcss.com"></script> <!-- Perbaiki spasi -->
  <style>
...
<body class="min-h-screen flex items-center justify-center px-4">
  <!-- Tambahkan margin-top untuk jarak dari atas di tampilan responsif -->
  <div class="max-w-3xl w-full bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl p-6 md:p-10 text-center border border-gray-100 mt-16 md:mt-10">
    <div class="mb-8">
      <h1 class="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Pilih Peran Kamu</h1> <!-- Ukuran teks judul disesuaikan -->
    ...
    <!-- Tambahkan mt-6 untuk jarak antara teks dan card di layar kecil -->
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6"> 
      <!-- Freelancer Card -->
      <!-- Tambahkan aspect-square dan flex untuk membuat isi card rata tengah -->
      <a href="/register/freelancer"
        ...
        <img src="{{ asset('images/Freelancer2.png') }}" alt="Freelancer"
             class="w-20 md:w-24 mx-auto mb-4 md:mb-5 group-hover:scale-110 transition-transform duration-300"> <!-- Ukuran gambar disesuaikan -->
        <h2 class="text-lg md:text-xl font-semibold text-gray-800 group-hover:text-blue-600 transition-colors text-center"> <!-- Tambahkan text-center -->
          Freelancer
        </h2>
        <p class="text-gray-500 text-xs md:text-sm mt-2 md:mt-3 leading-relaxed text-center"> <!-- Ukuran teks dan margin disesuaikan, tambahkan text-center -->
      ...
      <a href="/register/client"
        ...
        <img src="{{ asset('images/client2.png') }}" alt="Client"
             class="w-20 md:w-24 mx-auto mb-4 md:mb-5 group-hover:scale-110 transition-transform duration-300"> <!-- Ukuran gambar disesuaikan -->
        <h2 class="text-lg md:text-xl font-semibold text-gray-800 group-hover:text-purple-600 transition-colors text-center"> <!-- Tambahkan text-center -->
          Client
        </h2>
        <p class="text-gray-500 text-xs md:text-sm mt-2 md:mt-3 leading-relaxed text-center"> <!-- Ukuran teks dan margin disesuaikan, tambahkan text-center -->
    ...
    <div class="mt-8 md:mt-10 text-xs sm:text-sm text-gray-600"> <!-- Ukuran teks disesuaikan -->
      Sudah punya akun?
