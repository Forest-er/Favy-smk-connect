...
<div class="max-w-7xl mx-auto px-1">
  ...
  <style>
    ...
    <section>
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 auto-rows-[200px]">
        ...
        <div class="relative group cursor-pointer row-span-2 overflow-hidden rounded-xl">
          <img
            src="https://fiverr-res.cloudinary.com/image/upload/f_auto,q_auto/v1/attachments/delivery/asset/d1a6f869830256edfbd3d2c7b887659b-1745375528/JAKEREID687.jpg"
            class="w-full h-full object-cover transition-transform duration-300 group-hover:scale-[1.02]"
          >
          <div
            class="absolute inset-0 bg-gradient-to-r from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition duration-500 flex items-end rounded-xl"
          >
        ...
        <div class="relative group cursor-pointer overflow-hidden rounded-xl">
          <img
            src="https://fiverr-res.cloudinary.com/image/upload/f_auto,q_auto,t_delivery_web_tile/v1/attachments/delivery/asset/ab4ff21f481dd694e39d66b620a9f940-1746012415/Wedding%20no%20word.png"
            class="w-full h-full object-cover transition-transform duration-300 group-hover:scale-[1.02]"
          >
          <div
            class="absolute inset-0 bg-gradient-to-r from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition duration-500 flex items-end rounded-xl"
    ...
    <!-- 🌑 FREELANCER POPUP PROFESIONAL DENGAN SCROLL & PANEL SAMPING -->
    ...
    >
      <div class="flex flex-col h-full">
        <!-- HEADER -->
        <div
          class="flex items-center justify-between p-6 border-b border-gray-200 sticky top-0 z-10 bg-white shadow-sm rounded-t-3xl"
        >
          <h3 class="text-xl font-semibold text-gray-800">Project</h3>
          <button onclick="window.history.back()" class="text-gray-400 hover:text-gray-600 text-2xl transition">
            &times;
          </button>
        </div>
  ...
  <div id="profileLayout" class="flex flex-col md:flex-row gap-8 p-8">
    ...
    <div class="flex-1 space-y-8">
      ...
      <div class="flex items-center gap-5 bg-white border border-gray-100 rounded-2xl p-5 shadow-md">
        <img
          src="{{ $task->user && $task->user->foto ? asset('storage/' . $task->user->foto) : 'https://i.pravatar.cc/150?img=' . rand(1, 70) }}"
        ...
        <div class="flex flex-col flex-1">
          ...
          <p class="text-green-600 text-sm mt-1">
            ...
            • Response: {{ $task->user->response_time ?? '1h' }}
          </p>
        </div>
      </div>
            ...
            <div id="sidePanel" class="w-full md:w-[300px] p-6 space-y-6">
              ...
              <div class="pt-4 border-t border-gray-200 space-y-5">
                <div>
                  ...
                  <a
                    href="/client/explore.show"
                    class="text-red-600 text-sm font-medium underline hover:text-red-800 transition mt-1 inline-block"
                  >
                    See details
                  </a>
                </div>
              ...
              <div class="pt-4 border-t border-gray-200">
                ...
                <p class="text-gray-500 text-xs mt-1">
                  Member since 
                  {{ optional($task->user)->created_at 
                      ? \Carbon\Carbon::parse($task->user->created_at)->format('M Y') 
                      : '-' }}
                </p>
              </div>
            </div>
