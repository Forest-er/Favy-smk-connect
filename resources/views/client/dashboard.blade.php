    ...
    <div class="max-w-7xl mx-auto px-1">
                    ...
                    <div class="relative w-[50%]">
                        <form>
                            <div class="flex flex-row">
                                ...
                                <button type="submit" class=" bg-white text-black py-3 px-5 rounded-r-full z-99"><i
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="flex items-center gap-2">
                                    <img src="https://i.pravatar.cc/150?u={{ $task->users_id }}"
        ...
        <section class="max-w-7xl mx-auto mb-16 px-1">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                <div
                    class="bg-gradient-to-br from-white via-gray-50 to-white rounded-2xl shadow-lg hover:shadow-xl transition duration-300 p-5 relative hover:-translate-y-1 cursor-pointer">
                    <span
                        class="absolute top-4 left-4 px-3 py-1 text-xs font-semibold rounded-full bg-pink-400 text-white">Best
                        Seller</span>
        ...
        <!-- Your Activity Overview (Professional Style) -->
        <section class="w-full mb-20 px-1">
            <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-8">
                <div class="flex items-center justify-between mb-8">
                    <h2 class="text-xl font-semibold text-gray-800">Your Activity Overview</h2>
                    <span class="text-sm text-gray-400">Last updated: Oct 2025</span>
                </div>

                <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                    <!-- Active Projects -->
                    <div
                        class="p-6 rounded-xl bg-gradient-to-br from-pink-50 to-white border border-gray-100 hover:shadow-md transition">
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm text-gray-500">Active Projects</span>
                            <i class="bi bi-briefcase text-pink-500 text-lg"></i>
                        </div>
                    ...
                    <!-- Completed -->
                    <div
                        class="p-6 rounded-xl bg-gradient-to-br from-blue-50 to-white border border-gray-100 hover:shadow-md transition">
                        <div class="flex items-center justify-between mb-2">
                    ...
                    <!-- Total Spent -->
                    <div
                        class="p-6 rounded-xl bg-gradient-to-br from-green-50 to-white border border-gray-100 hover:shadow-md transition">
                        <div class="flex items-center justify-between mb-2">
                    ...
                    <!-- Freelancers Hired -->
                    <div
                        class="p-6 rounded-xl bg-gradient-to-br from-yellow-50 to-white border border-gray-100 hover:shadow-md transition">
                        <div class="flex items-center justify-between mb-2">
...
<section class="w-full mb-10 px-1">
  <h2 class="text-2xl font-bold mb-6 text-gray-900">Get inspired by work done on Fiverr</h2>

  <!-- 🔹 Category Tabs -->
  <div class="w-full overflow-x-auto scrollbar-hide">
    <div class="flex gap-4 mb-8 text-[14px] font-medium min-w-max px-1">
      <button
        class="px-5 py-2.5 rounded-2xl text-gray-800 border border-gray-300 bg-transparent transition-all duration-500 ease-in-out hover:text-white hover:border-transparent hover:bg-gradient-to-r hover:from-indigo-400 hover:to-purple-400 hover:shadow-md whitespace-nowrap">
        Book design
      </button>
      <button
        class="px-5 py-2.5 rounded-2xl text-gray-800 border border-gray-300 bg-transparent transition-all duration-500 ease-in-out hover:text-white hover:border-transparent hover:bg-gradient-to-r hover:from-blue-400 hover:to-indigo-400 hover:shadow-md whitespace-nowrap">
        Architecture & Interior design
      </button>
      <button
        class="px-5 py-2.5 rounded-2xl text-gray-800 border border-gray-300 bg-transparent transition-all duration-500 ease-in-out hover:text-white hover:border-transparent hover:bg-gradient-to-r hover:from-purple-400 hover:to-pink-400 hover:shadow-md whitespace-nowrap">
        Mobile app development
      </button>
      <button
        class="px-5 py-2.5 rounded-2xl text-gray-800 border border-gray-300 bg-transparent transition-all duration-500 ease-in-out hover:text-white hover:border-transparent hover:bg-gradient-to-r hover:from-indigo-400 hover:to-blue-400 hover:shadow-md whitespace-nowrap">
        Presentation design
      </button>
      <button
        class="px-5 py-2.5 rounded-2xl text-gray-800 border border-gray-300 bg-transparent transition-all duration-500 ease-in-out hover:text-white hover:border-transparent hover:bg-gradient-to-r hover:from-pink-400 hover:to-rose-400 hover:shadow-md whitespace-nowrap">
        Website design
      </button>
      <button
        class="px-5 py-2.5 rounded-2xl text-gray-800 border border-gray-300 bg-transparent transition-all duration-500 ease-in-out hover:text-white hover:border-transparent hover:bg-gradient-to-r hover:from-cyan-400 hover:to-blue-400 hover:shadow-md whitespace-nowrap">
        UGC videos
      </button>
      <button
        class="px-5 py-2.5 rounded-2xl text-gray-800 border border-gray-300 bg-transparent transition-all duration-500 ease-in-out hover:text-white hover:border-transparent hover:bg-gradient-to-r hover:from-violet-400 hover:to-fuchsia-400 hover:shadow-md whitespace-nowrap">
        AI development
      </button>
    </div>
  </div>
...
<div class="relative group cursor-pointer row-span-2 overflow-hidden rounded-xl">
  <img src="https://fiverr-res.cloudinary.com/image/upload/f_auto,q_auto/v1/attachments/delivery/asset/d1a6f869830256edfbd3d2c7b887659b-1745375528/JAKEREID687.jpg"
  ...
  <button class="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition duration-300">
    ...
    <div class="relative group cursor-pointer overflow-hidden rounded-xl">
      <img src="https://fiverr-res.cloudinary.com/image/upload/f_auto,q_auto,t_delivery_web_tile/v1/attachments/delivery/asset/ab4ff21f481dd694e39d66b620a9f940-1746012415/Wedding%20no%20word.png"
        class="w-full h-full object-cover transition-transform duration-300 group-hover:scale-[1.02]">
      <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition duration-500 flex items-end rounded-xl">
    ...
    <!-- 🔹 Item 3 (kotak kecil panjang) -->
    <div class="relative group cursor-pointer col-span-1 overflow-hidden rounded-xl">
      <img src="https://images.unsplash.com/photo-1610878180933-92a6a20389d5?auto=format&fit=crop&w=800&q=60"
        class="w-full h-[150px] object-cover transition-transform duration-300 group-hover:scale-[1.02]">
      <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition duration-500 flex items-end rounded-xl">
        <div class="text-white text-sm p-3">
    ...
    <!-- 🔹 Item 4 (tinggi sedang) -->
    <div class="relative group cursor-pointer row-span-2 overflow-hidden rounded-xl">
      <img src="https://images.unsplash.com/photo-1606761568499-6f1a76e3b25d?auto=format&fit=crop&w=800&q=60"
        class="w-full h-full object-cover transition-transform duration-300 group-hover:scale-[1.02]">
      <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition duration-500 flex items-end rounded-xl">
        <div class="text-white text-sm p-3">
    ...
    <!-- 🔹 Item 5 (pendek panjang kecil) -->
    <div class="relative group cursor-pointer overflow-hidden rounded-xl">
      <img src="https://images.unsplash.com/photo-1598387993441-73b8e3b6c4f5?auto=format&fit=crop&w=800&q=60"
        class="w-full h-[170px] object-cover transition-transform duration-300 group-hover:scale-[1.02]">
      <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition duration-500 flex items-end rounded-xl">
        <div class="text-white text-sm p-3">
    ...
    <!-- 🔹 Item 6 (tinggi lagi) -->
    <div class="relative group cursor-pointer row-span-2 overflow-hidden rounded-xl">
      <img src="https://images.unsplash.com/photo-1606112219348-204d7d8b94ee?auto=format&fit=crop&w=800&q=60"
        class="w-full h-full object-cover transition-transform duration-300 group-hover:scale-[1.02]">
      <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition duration-500 flex items-end rounded-xl">
        <div class="text-white text-sm p-3">
