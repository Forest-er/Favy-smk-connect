...
<head>
  ...
  <meta name="description"
    content="I will draw realistic digital painting and background illustrations - frontend demo" />
...
<body class="antialiased bg-gray-50 text-gray-800"> <!-- Header -->
  <header class="bg-white border-b">
    <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between gap-6">
      <div class="flex items-center gap-4"> <a href="#" class="inline-flex items-center gap-2"> <svg
            xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-pink-500" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M3 7h18M5 12h14M7 17h10" />
          </svg> <span class="font-semibold text-lg">Fiverr — Demo</span> </a>
        <nav class="hidden sm:flex items-center gap-3 text-sm text-gray-500"> <a href="#"
            class="hover:underline">Graphics & Design</a> <span>›</span> <a href="#"
            class="hover:underline">Illustration</a> </nav>
      </div>
      <div class="flex items-center gap-3"> <button
          class="hidden md:inline-flex items-center gap-2 px-4 py-2 border rounded-lg text-sm hover:shadow-sm">Sign
          in</button> <button
      ...
      <section class="lg:col-span-8 space-y-6"> <!-- Title & seller -->
        <div class="bg-white p-6 rounded-2xl shadow-sm">
          ...
          <div class="flex items-center justify-between gap-4">
            <div class="flex items-center gap-4"> <img
                src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=80&auto=format&fit=crop&crop=faces"
                class="w-14 h-14 rounded-full border object-cover" />
              <div>
                <div class="flex items-center gap-2"> <span class="font-semibold">Jennina</span> <span
                    class="text-xs px-2 py-0.5 rounded-lg bg-gray-100 text-gray-600">Level 2</span> </div>
                <div class="text-sm text-gray-500">2 orders in queue • Avg. response time: 1 hour</div>
              </div>
            </div>
            <div class="flex items-center gap-3">
              <div class="flex items-center gap-1 text-yellow-500"> <svg xmlns="http://www.w3.org/2000/svg"
                  class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                  <path
                    d="M9.049 2.927a1 1 0 011.902 0l1.286 3.954a1 1 0 00.95.69h4.163a1 1 0 01.592 1.806l-3.37 2.45a1 1 0 00-.364 1.118l1.287 3.954a1 1 0 01-1.538 1.118L10 15.347l-3.356 2.37A1 1 0 015.106 16.6l1.286-3.954a1 1 0 00-.364-1.118L2.656 9.08A1 1 0 013.248 7.27h4.163a1 1 0 00.95-.69L9.049 2.927z" />
                </svg> <span class="font-medium">5.0</span> <span class="text-gray-400 text-sm">(26 reviews)</span>
              </div> <button class="px-3 py-2 border rounded-lg text-sm">Message</button>
            </div>
          </div>
        </div>
         <!-- Gallery -->
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm">
          ...
          <p class="text-gray-700 leading-relaxed mb-4">
            I'm a professional digital artist specializing in realistic digital paintings and richly detailed background
            illustrations.
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm">
          ...
          <div class="space-y-4 text-sm text-gray-700">
            <div class="flex items-start gap-3">
              <img
                src="https://images.unsplash.com/photo-1545996124-4b8a2a2b8d7e?q=80&w=80&auto=format&fit=crop&crop=faces"
                class="w-10 h-10 rounded-full object-cover">
              <div>
                <strong>Raisa</strong> • <span class="text-gray-400">2 days ago</span>
                <p>Amazing work! Colors and composition were beyond expectations.</p>
              </div>
            </div>
            <div class="flex items-start gap-3">
              <img
                ...
                class="w-10 h-10 rounded-full object-cover">
              <div>
                <strong>Aris</strong> • <span class="text-gray-400">1 month ago</span>
                <p>Delivered quickly and exactly as requested. Highly recommended.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="sticky top-6 space-y-4">
          <div class="bg-white p-6 rounded-2xl shadow-sm">
            <div class="flex items-start justify-between gap-4">
              <div>
                <div class="text-sm text-gray-500">Digital Painting Package</div>
                <div class="text-2xl font-extrabold mt-1">$150</div>
                <div class="text-xs text-gray-400 mt-1">Full color digital artwork with detailed background</div>
              </div>
              <div class="text-sm text-gray-400 text-right">
                <div class="mb-1">5-day delivery</div>
                <div class="mb-1">3 Revisions</div>
              </div>
            </div>
            ...
            <ul class="text-sm text-gray-700 space-y-2">
              ...
              <li class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-green-500"
                ...
                </svg> Include source file</li>
              <li class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-green-500"
                  viewBox="0 0 20 20">
                  <path d="M3 3h14v2H3V3zm0 4h14v10H3V7z" />
                </svg> Printable 300 DPI</li>
            </ul>

            <button id="continueBtn"
              class="mt-5 w-full py-3 bg-black text-white rounded-lg font-medium hover:opacity-95">Continue ➜</button>
  ...
  <footer class="border-t mt-12">
    <div class="max-w-7xl mx-auto px-6 py-8 text-sm text-gray-500 flex flex-col md:flex-row md:justify-between gap-4">
      <div>© 2025 Demo — Built with Tailwind</div>
      <div class="flex gap-4"> <a href="#" class="hover:underline">Help & Support</a> <a href="#"
          class="hover:underline">Terms</a> <a href="#" class="hover:underline">Privacy</a> </div>
    </div>
  </footer>
  <script> document.getElementById('continueBtn').addEventListener('click', () => { alert('Continue ➜ (demo) — implement checkout flow here.'); }); document.getElementById('contactBtn').addEventListener('click', () => { alert('Contact seller modal (demo).'); }); </script>
</body>
