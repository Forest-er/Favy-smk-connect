  ...
  <div class="max-w-7xl mx-auto px-6 py-8">
    ...
    <div class="relative rounded-3xl mb-10 overflow-hidden shadow-2xl">
      <div class="absolute inset-0">
        <div class="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1504384308090-c894fdcc538d')] bg-cover bg-center opacity-100 slide"></div>
        <div class="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1521737604893-d14cc237f11d')] bg-cover bg-center opacity-0 slide"></div>
        <div class="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1522202176988-66273c2fd55f')] bg-cover bg-center opacity-0 slide"></div>
    ...
    <section class="mb-12">
      <div class="flex justify-between items-center mb-6">
        ...
        <button class="text-purple-600 hover:text-purple-700 font-semibold text-sm flex items-center gap-2 transition">
    ...
    <section class="mb-12">
      <div class="bg-white rounded-2xl p-10 shadow-lg border border-gray-100">
        ...
        <div class="flex flex-wrap justify-center items-center gap-12">
          <img src="https://upload.wikimedia.org/wikipedia/commons/a/ab/Logo_Tokopedia.svg" class="h-8 grayscale hover:grayscale-0 transition opacity-60 hover:opacity-100">
          <img src="https://upload.wikimedia.org/wikipedia/commons/2/29/Shopee_logo.svg" class="h-8 grayscale hover:grayscale-0 transition opacity-60 hover:opacity-100">
          <img src="https://upload.wikimedia.org/wikipedia/commons/1/19/GoTo_Logo.svg" class="h-8 grayscale hover:grayscale-0 transition opacity-60 hover:opacity-100">
          <img src="https://upload.wikimedia.org/wikipedia/commons/3/3f/Bukalapak_logo.svg" class="h-8 grayscale hover:grayscale-0 transition opacity-60 hover:opacity-100">
        </div>
      </div>
    </section>
  </div>
