            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-md p-6">
                <div class="flex flex-col items-center mb-8">
                    <div class="relative w-20 h-20">
                        ...
                        <button type="button" onclick="document.getElementById('fotoInput').click()" class="absolute bottom-0 right-0 bg-white p-1.5 rounded-full shadow hover:bg-gray-100 border border-gray-200 transition" title="Ubah foto profil">
                    ...
                    <p class="mt-3 text-gray-700 font-medium text-sm">{{ $user->email }}</p>
                </div>
                ...
                <form class="space-y-6" action="{{ route('client.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" value="{{ old('nama', $user->nama) }}" placeholder="Masukkan nama panggilan" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-pink-400 focus:outline-none transition">
                    </div>

                    <div>
                        <label class="block text-gray-800 font-medium text-sm mb-1">Tulis bio kamu disini</label>
                        <textarea name="bio" placeholder="bio kamu..." class="w-full border border-gray-300 rounded-lg px-3 py-2 h-24 text-sm focus:ring-2 focus:ring-pink-400 focus:outline-none transition">{{ old('bio', $user
                        ->bio) }}</textarea>
                    </div>
                    ...
                    <div class="border-t border-gray-100 pt-4">
                        <div class="mb-4">
                            ...
                            <input type="text" name="places" value="{{ old('places', $user->places) }}" placeholder="PT Contoh ..." class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-pink-400 focus:outline-none transition">
                        </div>
                    </div>
